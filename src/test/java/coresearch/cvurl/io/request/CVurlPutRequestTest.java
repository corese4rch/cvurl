...
class CVurlPutRequestTest extends AbstractRequestTest {
    ...
    void shouldReturnStatusCodeOkWhenRequestIsValid() {
        ...
        wireMockServer.stubFor(put(urlEqualTo(TEST_ENDPOINT))
                .willReturn(aResponse()
                        .withStatus(HttpStatus.OK)));

        //when
        var response = cVurl.put(url)
                .body("")
                .asString()
                .orElseThrow(RuntimeException::new);

        //then
        verify(exactly(1), putRequestedFor(urlEqualTo(TEST_ENDPOINT)));
    ...
    void shouldReturnStatusCodeOkWhenQueryParameterIsSpecified() {
        ...
        wireMockServer.stubFor(put(urlEqualTo(TEST_ENDPOINT + "?param=param"))
                .willReturn(aResponse()
                        .withStatus(HttpStatus.OK)));
        ...
        //then
        verify(exactly(1), putRequestedFor(urlEqualTo(TEST_ENDPOINT + "?param=param")));
    ...
    void shouldReturnStatusCodeOkWhenQueryParametersAreSpecified() {
        ...
        wireMockServer.stubFor(put(urlEqualTo(TEST_ENDPOINT + "?param=param&param2=param2"))
                .willReturn(aResponse()
                        .withStatus(HttpStatus.OK)));
        ...
        //then
        verify(exactly(1), putRequestedFor(urlEqualTo(TEST_ENDPOINT + "?param=param&param2=param2")));
    ...
    void shouldReturnStatusCodeOkWhenHeaderIsProvided() {
        ...
        //then
        verify(exactly(1),
                putRequestedFor(urlEqualTo(TEST_ENDPOINT)).withHeader(HttpHeader.AUTHORIZATION, equalTo(TEST_TOKEN)));
    ...
    void shouldReturnStatusCodeOkWhenBodyIsList() throws JsonProcessingException {
        ...
        //then
        verify(exactly(1),
                putRequestedFor(urlEqualTo(TEST_ENDPOINT)));
