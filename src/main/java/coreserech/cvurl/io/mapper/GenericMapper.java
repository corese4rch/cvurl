...
/**
 * Mapper from/to String to/from some custom type. Used by {@link coreserech.cvurl.io.request.Request}
 * to map body from response to object of some type and by {@link coreserech.cvurl.io.request.RequestBuilder}
