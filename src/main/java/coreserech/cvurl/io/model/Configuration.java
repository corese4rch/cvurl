...
/**
 * Data class that holds configuration of {@link coreserech.cvurl.io.request.CVurl}
 */
public class Configuration {
    ...
    public static class ConfigurationBuilder {
        ...
        /**
         * Sets a global timeout for requests created by {@link coreserech.cvurl.io.request.CVurl}
         ...
         * will be create for each created {@link coreserech.cvurl.io.request.CVurl}. If mode
         * is set to SINGLETONE - then all instances of {@link coreserech.cvurl.io.request.CVurl}
         * that created from config with this mode will use the same {@link HttpClient}
         * configured on the first {@link coreserech.cvurl.io.request.CVurl} creation.
         *
